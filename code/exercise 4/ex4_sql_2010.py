...
# Write the SQL query to filter rows where "Premis Desc" is equal to "STREET"
# and group by TimeSegment, counting the number of rows for each group
sql_query = """
    SELECT TimeSegment, COUNT(*) AS Count
    FROM crime_data
